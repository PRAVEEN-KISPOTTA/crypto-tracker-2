...
const fetchCoins = async () => {
    try{
        const response = await fetch('https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_desc&per_page=50&page=1', options);
...
// sort data with respect to price
...
// sort data with respect to volume
...
//display func is for rendering data in browser
...
//fetching data without effecting original fetch function
